...
public class ReceiptDataSource {
	...
	public Receipt saveReceipt(Receipt receipt) {
		...
		values.put(ReceiptSQLiteHelper.DESCRIPTION_COLUMN, receipt.getDescription());		
		values.put(ReceiptSQLiteHelper.IMAGE_PATH_COLUMN, receipt.getImagePath());
	...
	private Receipt createReceiptFromCursor(Cursor cursor) {
		...
		return new Receipt(receiptId, client, category, parseDate(date), amount, description, imagePath);
	}
